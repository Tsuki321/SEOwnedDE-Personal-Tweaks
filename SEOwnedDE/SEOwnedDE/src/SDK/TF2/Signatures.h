...
MAKE_SIGNATURE(CMatSystemSurface_StartDrawing, "vguimatsurface.dll", "40 53 56 57 48 83 EC 50", 0);
MAKE_SIGNATURE(CMatSystemSurface_FinishDrawing, "vguimatsurface.dll", "40 53 48 83 EC 20 33 C9", 0);
...
MAKE_SIGNATURE(CBasePlayer_CalcPlayerView, "client.dll", "55 8B EC 83 EC 18 53 8B 5D 0C 56 8B", 0);
MAKE_SIGNATURE(AttribHookValue, "client.dll", "55 8B EC 83 EC 10 8B 0D ? ? ? ? 53 56 57 33 F6 33 FF 89 75 F0 89 7D F4 8B 41 08 85 C0 74 38 68 ? ? ? ? 68 ? ? ? ? 68 ? ? ? ? 68 ? ? ? ? 6A 6B 68 ? ? ? ? 57 57 57 57 8D 4D F0 51 50 8B 40 50 FF D0 8B 7D F4 83 C4 30 8B 75 F0 8B 0D ? ? ? ? 8B 59 08 8B 0D ? ? ? ? 8B 81 0C 10 00 00 89 45 F8 85 C0 74 1C 6A 04 6A 00 68 ? ? ? ? 6A 00 68 ? ? ? ? FF 15 ? ? ? ? 8B 0D ? ? ? ? 8B 45 0C 85 C0 74 67", 0);
MAKE_SIGNATURE(CBaseEntity_BaseInterpolatePart1, "client.dll", "55 8B EC 8B 45 18 56 8B F1", 0);
MAKE_SIGNATURE(CMultiPlayerAnimState_Update, "client.dll", "55 8B EC 81 EC ? ? ? ? 53 57 8B F9 8B 9F ? ? ? ? 89 5D E0 85 DB", 0);
MAKE_SIGNATURE(CSequenceTransitioner_CheckForSequenceChange, "client.dll", "55 8B EC 53 8B 5D 08 57 8B F9 85 DB 0F 84 ? ? ? ? 83", 0);
...
MAKE_SIGNATURE(CTFViewModel_CalcViewModelView, "client.dll", "55 8B EC 81 EC ? ? ? ? 8B 55 0C", 0);
MAKE_SIGNATURE(INetChannel_SendNetMsg, "engine.dll", "55 8B EC 57 8B F9 8D 8F 94 00 00 00 E8 ? ? ? ? 85 C0 75 07 B0 01 5F 5D C2 0C", 0);
...
MAKE_SIGNATURE(CL_Move, "engine.dll", "55 8B EC B8 2C 10 00 00 E8 ? ? ? ? 83", 0);
...
MAKE_SIGNATURE(C_BaseAnimating_SetupBones, "client.dll", "55 8B EC 81 EC 8C 0E 00 00 53", 0);
...
MAKE_SIGNATURE(CTFPlayer_FireBullet, "client.dll", "53 8B DC 83 EC 08 83 E4 F0 83 C4 04 55 8B 6B 04 89 6C 24 04 8B EC 81 EC C8 01 00 00 56 57 8B F9 8B", 0);
